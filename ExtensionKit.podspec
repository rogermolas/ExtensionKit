...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Roger Molas/ExtensionKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Roger Molas' => 'r.molas06@gmail.com' }
  s.source           = { :git => 'https://github.com/Roger Molas/ExtensionKit.git', :tag => s.version.to_s }
